...
When a LinchPin transaction occurs, there are many variables which are passed
in and used. Some are generated by LinchPin, these are referred to as 'magic'
variables. Additionally, user specific variables can be passed from the
PinFile. In each case, these **vars** have a sub-section within the vars
section in the RunDB.
    ...
    "vars": [
        ...
        },
        {
            "lp": {
                ...
                "rundb_schema": {"action": "", "inputs": [], "outputs": [], "vars": [], "start": "", "end": "", "rc": 0, "uhash": ""},
                "rundb_hash": "sha256",
